  ...
  return (
    ...
    >
      <div className="what-is-mirketgiller max-w-7xl px-8 flex items-center gap-16 lg:gap-[100px] flex-col lg:flex-row">
        <div className="images-container flex items-center gap-8 w-full md:w-[80%] lg:w-1/2 h-max-[670px]">
          <div className="left-column w-1/2 flex flex-col gap-8 h-fit justify-center">
            <img
              src="https://placehold.co/270x320"
              alt=""
              className="aspect-[27/32] w-full object-cover rounded-[16px]"
            />
            <img
              src="https://placehold.co/270x320"
              alt=""
          ...
          <div className="right-column w-1/2 h-fit flex items-center">
            <img
              src="https://placehold.co/270x400"
              alt=""
              className="aspect-[27/40] w-full object-cover rounded-[16px]"
            />
          </div>
        </div>
        ...
        <div className="content-container flex flex-col w-full md:w-[80%] lg:w-1/2 gap-8">
          <div className="text-container flex flex-col gap-4">
            ...
            >
              ...
              birlikte almanıza olanak tanıyor. Bu yolculukta, her bir
              üniversite öğrencisinin mezuniyet öncesinde ulaşabileceği en
              yüksek noktayı hedeflemesini sağlıyoruz.
            </p>
          </div>
